        ...
        function renderGameLogs(gameLogs, player, playerRanks) {
            ...
            if (gameLogsWithData.length > 0) {
                ...
                for (const key of orderedStatKeys) {
                    ...
                    td.innerHTML = formatStatWithRank(displayValue, rank);
            ...
            for (const statKey of orderedStatKeys) {
                if (statLabels[statKey]) {
                    ...
                    displayValues.forEach((val, i) => {
                        ...
                        td.innerHTML = val === 'N/A' ? 'N/A' : formatStatWithRank(val, rank);
  ...
  `;
    ...
    hideLegend();
        ...
        function formatStatWithRank(statValue, rank) {
            if (rank) {
                return `${statValue}<span class="rank-superscript">(${rank})</span>`;
            }
            return statValue;
        }
