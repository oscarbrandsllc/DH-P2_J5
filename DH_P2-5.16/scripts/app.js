    ...
    hideLegend();
        ...
        function renderGameLogs(gameLogs, player, playerRanks) {
            ...
            const teamTagHTML = (player.team && player.team !== 'FA')
              ? `<img class="team-logo glow" src="${src}" alt="${teamKey}" width="24" height="24" loading="lazy" style="margin-left: 8px;">`
              : `<div class="team-tag" style="background-color: #64748b; color: white; width: 24px; height: 24px; font-size: 10px; margin-left: 8px;">FA</div>`;

            headerContainer.innerHTML += teamTagHTML;
            ...
            if (gameLogsWithData.length > 0) {
                ...
                totalTh.innerHTML = `Season<br><span style="font-size: 0.7em; color: var(--color-text-tertiary);">GP: ${gamesPlayed}</span>`;
